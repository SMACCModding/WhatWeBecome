modded class LoginQueueBase extends UIScriptedMenu
{
	...
	{	
		layoutRoot = GetGame().GetWorkspace().CreateWidgets("Deserted/gui/ftm_dialog_queue_position.layout");
...
modded class LoginTimeBase extends UIScriptedMenu
{
	...
	override Widget Init()
	{	
		layoutRoot = GetGame().GetWorkspace().CreateWidgets("Deserted/gui/ftm_dialog_login_time.layout");
...
modded class LoadingScreen
{
	...
	void LoadingScreen(DayZGame game)
	{
        ...
        ref TStringArray loadingScreenArray = {"Deserted/gui/ftm_loading_11.layout", "Deserted/gui/ftm_loading_2.layout", "Deserted/gui/ftm_loading_3.layout", "Deserted/gui/ftm_loading_4.layout", "Deserted/gui/ftm_loading_5.layout", "Deserted/gui/ftm_loading_6.layout", "Deserted/gui/ftm_loading_7.layout", "Deserted/gui/ftm_loading_8.layout", "Deserted/gui/ftm_loading_9.layout", "Deserted/gui/ftm_loading_10.layout", "Deserted/gui/ftm_loading_1.layout"};
        m_WidgetRoot = game.GetLoadingWorkspace().CreateWidgets(loadingScreenArray.GetRandomElement());
...
modded class ConnectionLost
{
	...
	{		
		m_WidgetRoot = game.GetWorkspace().CreateWidgets("Deserted/gui/ftm_day_z_connection_lost.layout");
		m_WidgetRoot.Show(false);
