modded class LoginQueueBase extends UIScriptedMenu
{
	...
	{	
		layoutRoot = GetGame().GetWorkspace().CreateWidgets("Overgrown/data/gui/ftm_dialog_queue_position.layout");
...
modded class LoginTimeBase extends UIScriptedMenu
{
	...
	override Widget Init()
	{	
		layoutRoot = GetGame().GetWorkspace().CreateWidgets("Overgrown/data/gui/ftm_dialog_login_time.layout");
...
modded class LoadingScreen
{
	...
	void LoadingScreen(DayZGame game)
	{
        ...
        ref TStringArray loadingScreenArray = {"Overgrown/data/gui/ftm_loading_1.layout","Overgrown/data/gui/ftm_loading_2.layout"};
...
modded class ConnectionLost
{
	...
	{		
		m_WidgetRoot = game.GetWorkspace().CreateWidgets("Overgrown/data/gui/ftm_day_z_connection_lost.layout");
		m_WidgetRoot.Show(false);
